...
const Footer = () => {
  return (
    <div>
      <div className="bg-[#2d988a] text-center text-gray-100 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
        ...
        <div className="bg-[#2d988a] p-3 text-center dark:bg-neutral-700">
