...
import { BsRss, BsSendArrowUpFill } from "react-icons/bs";
...
const BlogPage = () => {
  ...
  return (
    <div className="relative max-lg:pt-[80px] lg:pt-[100px] bg-gray-100">
      {loading ?
      ...
      <div>
        ...
        <div className="lg:mx-[48px] lg:pl-16">
          <div className="lg:flex lg:gap-7 pb-20 max-lg:px-7">
            <div className="lg:w-[75%] ">
              ...
              <div className="h-10 max-lg:mx-auto max-lg:mt-7 bg-white min-w-32 w-fit max-w-64 flex items-center justify-center px-4 mb-5 cursor-pointer rounded-3xl  text-teal-400 font-medium drop-shadow-lg  transition-transform duration-500 hover:scale-105"
                onClick={()=>Navigate(`/categories/${detailPost[0]?.Categories}/${detailPost[0]?.Similar}`)}
              >
              ...
              />
              <div className="max-lg:my-5 w-full bg-gray-50 rounded-xl p-5">
