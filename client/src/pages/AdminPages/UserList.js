...
import { fetchUsers, deleteAccount, searchUser, usersFilter, doctorRegister } from "../../redux-toolkit/authSlice";
...
const UserList = () => {
  ...
  const {allSearchUsers, filter, loading} = useSelector((state) => state.user);
  ...
  const handleCreateAccount = () => {
    ...
    if (
      ...
      dispatch(doctorRegister(data)).then(()=>{
        handleClose()
      });
    }
  }
  return (
    <div className="lg:pt-[70px] table-auto md:mx-auto px-10 scrollbar scrollbar-track-slate-100 scrollbar-thumb-slate-300 dark:scrollbar-track-slate-700 dark:scrollbar-thumb-slate-500">
       {loading ?
      ...
      <div className="h-screen pb-20"> 
        {profile ?
        <div className="mt-5 py-7 h-[90%] w-full rounded-xl bg-white shadow-lg max-lg:px-6 lg:px-8">
        ...
        <div className="lg:pt-4 h-full">
          <div className="flex gap-4 mb-3 items-center">
            ...
            {(isSearched) && <IoIosCloseCircleOutline className="h-6 w-6 text-rose-600 cursor-pointer" onClick={()=>{handleClose();setIsSearched("");setKeywordUser("")}}/>}
            {!showFilterModal &&
          ...
          <div className="overflow-auto h-[83%] bg-white rounded-lg shadow-lg">
          ...
          <div className="flex flex-col gap-3 px-4 items-center justify-center">
            ...
            <div className="w-full flex flex-col gap-2">
              <div className="">
                ...
                <Input className={` ${formErrors?.fullname ? "border-red-500" : "border-slate-200"} h-9 w-full rounded-lg `}
                       type="text"
                       name="fullname"
              ...
              <div className="">
                ...
                <Input className={` ${formErrors?.email ? "border-red-500" : "border-slate-200"} h-9 w-full rounded-lg `}
                       type="text"
                       name="email"
