      ...
      <div className="my-4 w-[80%] p-8 rounded-xl bg-white shadow-lg shadow-violet-200">
        ...
        <div className="flex flex-col gap-6 px-40 mb-5">
            <div className="flex gap-8 items-center">
                <div className="h-32 w-32 rounded-3xl shadow-lg shadow-violet-200 bg-lime-50 flex items-center justify-center">
                    <img className="w-28 h-28" src={categories[0]?.Image} alt=""></img>
                </div>
                <p className="mt-10 text-slate-600 text-2xl font-bold">{categories[0]?.Categories}</p>
            </div>
