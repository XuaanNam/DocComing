...
('Anh', 'Quốc', 'admin@doccoming.com', "$2b$07$agI47Yp3nBMhrz7oNNkMA.hfqPTbmWpnxGCuqmm8k11bbSr.1Zici", 0123456789, 0),
('Benh', 'Nhan', 'patient@doccoming.com', "$2b$07$agI47Yp3nBMhrz7oNNkMA.hfqPTbmWpnxGCuqmm8k11bbSr.1Zici", 0123456789, 1),
('Dung', 'Nguyễn Thị Kim', 'kimdung@gmail.com', "$2b$07$agI47Yp3nBMhrz7oNNkMA.hfqPTbmWpnxGCuqmm8k11bbSr.1Zici", 0123456789, 2),
('Lâm', 'Nguyễn Sơn', 'sonlamg@gmail.com', "$2b$07$agI47Yp3nBMhrz7oNNkMA.hfqPTbmWpnxGCuqmm8k11bbSr.1Zici", 0123456789, 2),
('Nghi', 'Lê Hoàng Hạnh', 'hanhnghig@gmail.com', "$2b$07$agI47Yp3nBMhrz7oNNkMA.hfqPTbmWpnxGCuqmm8k11bbSr.1Zici", 0123456789, 2),
('Hiếu', 'Trương Quang', 'quanghieu@gmail.com', "$2b$07$agI47Yp3nBMhrz7oNNkMA.hfqPTbmWpnxGCuqmm8k11bbSr.1Zici", 0123456789, 2);
-- drop table account;
...
INSERT INTO `doccoming`.`service` (`id`, `Service`) VALUES ('11', 'Khám tổng quát');
...
INSERT INTO `doccoming`.`servicedoctor` (`idService`, `idDoctor`, `EstimatedTime`, `Price`, `Status`) VALUES ('14', '235523487', '00:30:00', '200000', '0');
...
INSERT INTO `doccoming`.`servicedoctor` (`idService`, `idDoctor`, `EstimatedTime`, `Price`, `Status`) VALUES ('13', '235523488', '01:00:00', '200000', '0');
INSERT INTO `doccoming`.`servicedoctor` (`idService`, `idDoctor`, `EstimatedTime`, `Price`, `Status`) VALUES ('12', '235523489', '01:00:00', '300000', '0');
INSERT INTO `doccoming`.`servicedoctor` (`idService`, `idDoctor`, `EstimatedTime`, `Price`, `Status`) VALUES ('1', '235523489', '01:00:00', '200000', '0');
INSERT INTO `doccoming`.`servicedoctor` (`idService`, `idDoctor`, `EstimatedTime`, `Price`, `Status`) VALUES ('4', '235523490', '01:00:00', '400000', '0');
INSERT INTO `doccoming`.`servicedoctor` (`idService`, `idDoctor`, `EstimatedTime`, `Price`, `Status`) VALUES ('3', '235523490', '01:00:00', '300000', '0');
...
; -- drop table schedule
UPDATE `doccoming`.`schedule` SET `FirstShiftStart` = '08:00:00', `FirstShiftEnd` = '11:00:00', `SecondShiftStart` = '13:00:00', `SecondShiftEnd` = '17:00:00' WHERE (`id` = '2');
UPDATE `doccoming`.`schedule` SET `FirstShiftStart` = '9:00:00', `FirstShiftEnd` = '12:00:00', `ThirdShiftStart` = '18:00:00', `ThirdShiftEnd` = '21:00:00' WHERE (`id` = '3');
UPDATE `doccoming`.`schedule` SET `FirstShiftStart` = '7:30:00', `FirstShiftEnd` = '11:30:00', `SecondShiftStart` = '14:00:00', `SecondShiftEnd` = '17:00:00' WHERE (`id` = '4');
UPDATE `doccoming`.`schedule` SET `SecondShiftStart` = '13:00:00', `SecondShiftEnd` = '17:00:00', `ThirdShiftStart` = '19:00:00', `ThirdShiftEnd` = '21:30:00' WHERE (`id` = '5');
